...
class AppColor {
  ...
  // static const primaryVariant = Color(0xFFE0D2CF);
  ...
  // static const lightBrown = Color(0xFFAFA2AB);
  // static const darkBlue = Color(0xFF203242);
  static const lightText = Color(0xB3FFFFFF);
  ...
  // static const unSelectText = Color(0xFFC7CCD0);
  static final white70Color = AppColor.white.withOpacity(0.70);
  static const hintColor = Color(0xFFACACAC);
...
///revamp
  ...
  static const Bludae = Color(0xff061A33);
