...
class OngoingJobDetailView extends StatelessWidget {
  const OngoingJobDetailView({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                12.heightSpace,
                Text(
                  "Congratulations for completing the job, The job wil be in review, wait for the approval from customer side.",
