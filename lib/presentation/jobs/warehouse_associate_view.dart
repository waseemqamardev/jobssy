...
class WarehouseAssociateView extends StatelessWidget {
  final bool isInProgress;

  const WarehouseAssociateView({super.key, this.isInProgress = false});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  7.5.heightSpace,
                  _infoRow(Assets.iconsJobsTime, "Nov 25, 2025 at 9:00 AM - 5:00 PM"),
                  7.5.heightSpace,
                  _infoRow(Assets.iconsJobsLocation, "123 Industrial Blvd, Austin, TX"),
                  15.heightSpace,
  ...
  Widget _infoRow(String assetPath, String text) {
    return Row(
      ...
      children: [
        ...
        7.widthSpace,
        Text(text, style: FontHelper.f14w400Regular.copyWith(color: AppColor.black)),
      ],
    );
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                "Job QR Code",
                style: FontHelper.f16w500MediumStyle.copyWith(color: AppColor.black, fontWeight: FontWeight.w400),
              ),
            ],
          ),
          15.heightSpace,
          ...
          if (!isInProgress) ...[
            ...
            Text(
              ...
              style: FontHelper.f15w400Regular.copyWith(color: AppColor.tertiary),
            ),
          ],
        ],
      ),
