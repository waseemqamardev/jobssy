...
class CustomerViewProfileView extends StatefulWidget {
  const CustomerViewProfileView({super.key});

  @override
  State<CustomerViewProfileView> createState() =>
      _CustomerViewProfileViewState();
}

class _CustomerViewProfileViewState extends State<CustomerViewProfileView> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    12.heightSpace,
                    _confirmationCheckboxes(
                      "I agree to Jobssy's business posting policies.",
                      isPolicyAgreed,
                      (val) {
                        setState(() {
                          isPolicyAgreed = val!;
  ...
  // -------------------- BOTTOM SHEET --------------------
  Widget _confirmationCheckboxes(
